...
print(f"Porcentaje de elementos de Q encima del promedio: { (Q > Q.mean()).sum() * (100 / (Q == Q).sum()) }")
...
suma_dados =  rd.choice([1,2,3,4,5,6]) + rd.choice([1,2,3,4,5,6])
...
D = [rd.choice([1,2,3,4,5,6]) + rd.choice([1,2,3,4,5,6]) for i in range(1001)]
